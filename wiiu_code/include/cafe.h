...
typedef int (*FSWriteFile_t)(FSClient *client, FSCmdBlock *block, void *buffer, u32 size, u32 count, int handle, u32 flags, int errHandling);
...
typedef u32 (*nn_act_Initialize_t)();
typedef u32 (*nn_act_Finalize_t)();
typedef u8  (*nn_act_GetSlotNo_t)();
typedef u32 (*nn_act_GetPersistentIdEx_t)(u8 slot);
